   ...
   <tbody>
     ...
     // print_r($bookinfo);die();
      ...
      <tr>
         ...
         <td><?php echo html_escape($book->overalltotal);?></td>
           <td><?php echo html_escape($book->advance_amount);?></td>
         <td><?php echo html_escape($book->paid_amount);?></td>
         
         <td><?php echo ($book->total_price-$book->paid_amount)<0 ? 0 : html_escape($book->total_price-($book->paid_amount-$book->advance_amount));?></td>
