...
function childprice() {
    ...
    var start = $(".datefilter3").val();
    var end = $(".datefilter4").val();
            ...
            success: function(response) {
                ...
                if (response.user != "Not found") {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        $('#arrival_from').val(response.user[i].city);
...
function newBooking() {
    ...
    for (var s = 0; s < all -1; s++) {
        extrastart += ",".concat($("#from_date2"+(s+1)).val());
    }
    ...
    for (var s = 0; s < all -1; s++) {
        extraend += ",".concat($("#to_date2" + (s+1)).val());
    }
  ...
  var items=document.getElementsByName('additional');
                var selectedItems="";
