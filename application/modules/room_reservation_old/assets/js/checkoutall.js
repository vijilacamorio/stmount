...
// }
//  $("#totalroomrentamount").text(allbpccharge+parseFloat(rentafterdiscount1));
//     var totalrentandtax = (rentafterdiscount1)+allbpccharge+additionalcharge;
//     var tax12percent = (totalrentandtax * 12) / 100;
//     var payableamount = totalrentandtax - alladvanceamount ;
...
//       var val=allbpccharge+parseFloat(rentafterdiscount1)+additionalcharge+parseFloat(tax12percent);
...
$("#additionalcharge").on("keyup change", function() {
    ...
    if (isNaN(complemetaryamt)) {
      ...
      if (isNaN(amount)) {
        ...
        var CGST = (totalrentandtax * 6) / 100;
        var SGST = (totalrentandtax * 6) / 100;
        var final = totalrentandtax + CGST + SGST + additionalcharge;
...
function checkout() {
    ...
    var totalroomrent = parseFloat($("#allroomrent").text());
    var tax_with_amount=$("#tax_with_amount").text();
