...
$("#multipayment").on("click", function () {
  ...
  td +=
    ...
    i +
    '" class="form-control form-control-sm"></div><div class="col"><input type="text" id="recdate_' +
    i +
    '" class="form-control form-control-sm">' +
    '<select class="selectpicker form-select" data-live-search="true" data-width="100%" id="bankname_' +
    i +
    '">' +
    bankinfo +
    '</select></div><div class="col"><input type="password" id="cvv_' +
        i +
        ...
        '<div class="col"><input type="text" id="online_referenceno_' +
        i +
        '" class="form-control form-control-sm" placeholder="Online Reference Number" style="display:none;"></div>' +
...
if (pmode == "Card Payment") {
  ...
  $("#online_referenceno_" + l).prop("style", "display:none;");
