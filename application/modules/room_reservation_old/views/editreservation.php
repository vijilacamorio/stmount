...
<div class="row">
    ...
    <div class="col-lg-6 d-flex">
        <div class="card flex-fill w-100">
           ...
           <div class="col-md-12 mb-3" id="onlinereferencediv" <?php if ($payment_method->paymenttype != 'Bank Payment') { echo "hidden"; } ?> >
    <div class="form-group mb-0">
        <label class="font-weight-600 mb-1"><?php echo "Bank Name" ?></label>
        <div class="icon-addon addon-md">
            <input type="text" <?php if ($bookingpaymentdata->paymenttype == 'Bank Payment') { echo "readonly"; } ?> value='<?php echo $ref ?>' class="form-control" id="bankname" style="width: 858px;" placeholder="Bank Name">
        </div>
    </div>
</div>
