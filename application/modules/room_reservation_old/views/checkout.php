    ...
    <div class="col-md-12 mb-3">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h4><?php echo "Checkout List"; ?><small class="float-right"><a href="<?php echo base_url('room_reservation/viewCheckout/'); ?>" class="btn btn-primary btn-md"><i class="ti-plus" aria-hidden="true"></i> <?php echo "Direct Checkout"; ?></a></small></h4>
            </div>
            <div class="row">
                <!--  table area -->
                <div class="col-sm-12">
