                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center" class="invp-24">
                    <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="invp-26" width="80">
                                <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span class="sub"> <?php echo $bookingdata[0]->rent+$bookingdata[0]->sgst+$bookingdata[0]->cgst; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                            </td>
                        </tr>
                        <!--<tr>-->
                        <!--    <td class="invp-27">-->
                        ...
                        <tr>
                            ...
                            <td class=" invp-25">
                                <small><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span class='adv'><?php echo html_escape($bookingdata[0]->adv_amt); ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></small>
                            </td>
                        </tr>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <td class="invp-28">
                                <strong
                                    id="inpayableamt"><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php   echo $bookingdata[0]->rent+$bookingdata[0]->sgst+$bookingdata[0]->cgst;; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
