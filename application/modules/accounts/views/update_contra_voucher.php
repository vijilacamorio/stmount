    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
                <div class="card-header">
                    <h4>
                     <?php echo "Update ".display('contra_voucher')?>
                    </h4>
                </div>
            <div class="card-body">
            ...
            <?php echo form_open_multipart('accounts/accounts/update_contra_voucher') ?>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="txtVNo" id="txtVNo" value="<?php echo html_escape($crvoucher_info[0]->VNo); ?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="date" class="col-sm-2 col-form-label"> <?php echo display('date')?></label>
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" class="form-control datepickers" value="<?php echo html_escape($crvoucher_info[0]->VDate);?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"> <?php echo display('remark')?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php echo html_escape($crvoucher_info[0]->Narration)?></textarea>
                        </div>
                    </div> 
                       <div class="table-responsive mt_10px">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="debitvoucher">
                                        ...
                                        foreach ($crvoucher_info as $single) {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="txtCode[]"  class="form-control text-center"  id="txtCode_<?php echo $sl; ?>" required value="<?php echo html_escape($single->COAID); ?>"></td>
                                                <td><input type="text" name="txtAmount[]" class="form-control total_price text-right" value="<?php echo html_escape($single->Debit);
                                                            $dbt += $single->Debit; ?>" placeholder="0"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculation(<?php echo $sl; ?>)" required>
                                                </td>
                                                <td>
                                                    <input type="text" name="txtAmountcr[]"  class="form-control total_price1 text-right" value="<?php echo html_escape($single->Credit);
                                                            $cdt += $single->Credit; ?>" placeholder="0"  id="txtAmount1_1" onkeyup="calculation(<?php echo $sl; ?>)" required>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger red t_right" type="button" value="Delete" onclick="deleteRow(this)"><i class="ti-trash"></i></button>
                                                </td>
                                            </tr>                              
                                            <?php
                                            $sl++;
                                ...
                                <tfoot>
                                        <tr>
                                            <td >
                                                <input type="button" id="add_more" class="btn btn-info" name="add_more"  onClick="addaccountUpdate('debitvoucher');" value="<?php echo display('add_more') ?>" />
                                            </td>
