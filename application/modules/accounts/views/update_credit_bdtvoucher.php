<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
                <div class="card-header">
                    <h4>
                     <?php echo "Update ".display('credit_voucher')?>
                    </h4>
            </div>
            <div class="card-body">
            ...
            <?php echo form_open_multipart('accounts/accounts/update_credit_voucher') ?>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="txtVNo" id="txtVNo" value="<?php echo html_escape($debit_info->VNo); ?>" class="form-control" readonly>
                        </div>
                    </div> 
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select name="cmbDebit" id="cmbDebit" class="form-control">
                            ...
                            <option value="<?php echo html_escape($cracc->HeadCode)?>" <?php if($debit_info->COAID == $cracc->HeadCode){
                              echo 'selected';
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" class="form-control datepickers" value="<?php echo html_escape($debit_info->VDate);?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark') ?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php echo html_escape($debit_info->Narration);?></textarea>
                        </div>
                    </div> 
   ...
   <option value="<?php echo html_escape($acc1->HeadCode);?>" <?php if($upcrvoucher->COAID == $acc1->HeadCode){
                              echo 'selected';
         ...
         <?php }?>
                                        ...
                                        <td><input type="text" name="txtCode[]" value="<?php echo html_escape($upcrvoucher->COAID) ?>" class="form-control "  id="txtCode_<?php echo $sl; ?>" required></td>
                                        <td><input type="text" name="txtAmount[]" value="<?php echo html_escape($upcrvoucher->Credit) ?>" class="form-control total_price"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculation(<?php echo $sl; ?>)" required>
                                           </td>
                                       <td>
                             ...
                             <tfoot>
                                    <tr>
                                      <td >
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right " name="grand_total" value="<?php echo html_escape($debit_info->Debit);?>" readonly="readonly" />
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
