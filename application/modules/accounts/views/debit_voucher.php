                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="ac"
                                    class="col-sm-2 col-form-label"><?php echo display('credit_account_head')?></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="dtpDate" class="form-control datepickers"
                            ...
                            <div class="table-responsive mt_10px">
                                <table class="table table-bordered table-hover" id="debtAccVoucher">
                                    ...
                                    <tbody id="debitvoucher">
                                        ...
                                        <tr>
                                            <td class="form-group">
                                                <select name="cmbCode[]" id="cmbCode_1"
                                                    class="form-control basic-single" data-live-search="true"
                                                    onchange="load_code(this.value,1)">
                                            ...
                                            <td><input type="text" name="txtCode[]" value="" class="form-control "
                                                    id="txtCode_1" required></td>
                                            <td><input type="text" name="txtAmount[]" value=""
                                                    class="form-control total_price" id="txtAmount_1"
                                                    onkeyup="calculation(1)" required>
                                            </td>
                                            <td>
                                                <button class="btn btn-danger red t_right" type="button"
                                                    value="<?php echo display('delete')?>" onclick="deleteRow(this)"><i
                                        ...
                                        <tr>
                                            <td>
                                                <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                                    onClick="addaccountDevid('debitvoucher');"
