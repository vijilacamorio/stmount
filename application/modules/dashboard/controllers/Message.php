...
class Message extends MX_Controller {
    ...
    { 
        ...
        $this->form_validation->set_rules('receiver_id', display('receiver_name') ,'required|max_length[11]|xss_clean');
        $this->form_validation->set_rules('subject', display('subject'),'required|max_length[255]|xss_clean');
        $this->form_validation->set_rules('message', display('message'),'required|trim|xss_clean');
        /*-------------STORE DATA------------*/
        $id = $this->session->userdata('id');
