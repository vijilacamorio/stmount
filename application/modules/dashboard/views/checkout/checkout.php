    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6><?php echo display("checkout") ?></h6>    
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-sm" language_list>
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><?php echo display('subtitle'); ?></th>
                                ...
                                <?php foreach ($company_list as $company) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" onclick="checkoutimage_edit('<?php echo html_escape($company->slid); ?>')" class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>  
                ...
                <!-- The Modal -->
                <div class="modal fade" id="checkout_info" role="dialog">
            ...
            <div class="card-header">
                <h6><?php echo display("booking_conditions") ?></h6>    
            </div>
            <div class="card-body">
                <!-- language -->
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" language_list>
                        <thead>
                            <tr>
                                ...
                                <th width="60%"><?php echo display('description'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $sl++ ?></td>
                                <td><?php echo html_escape($condition->widget_title); ?></td>
                                <td><?php echo html_escape($condition->widget_desc); ?></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="condition_edit('<?php echo html_escape($condition->widgetid); ?>')"
                            ...
                            <tr>
                                <td><?php echo $sl++ ?></td>
                                <td><?php echo html_escape($condition1->widget_title); ?></td>
                                <td><?php echo html_escape($condition1->widget_desc); ?></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="condition_edit('<?php echo html_escape($condition1->widgetid); ?>')"
                                        class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>
                                </td>
                            </tr>
                            <?php $sl = 3 ?>
                            <tr>
                                <td><?php echo $sl++ ?></td>
                                <td><?php echo html_escape($condition2->widget_title); ?></td>
                                <td><?php echo html_escape($condition2->widget_desc); ?></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="condition_edit('<?php echo html_escape($condition2->widgetid); ?>')"
                                        class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
