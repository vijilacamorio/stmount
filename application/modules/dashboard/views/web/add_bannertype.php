...
<div class="row">
    <div class="col-sm-12 col-md-12">
            ...
            <div class="card-header">
                    <h4><?php echo html_escape((!empty($title)?$title:null)) ?> <small class="text-right"><button type="button" class="btn btn-primary my-modal pull-right" onclick="add_role()" >
                    ...
                    <table class="table table-bordered table-hover" id="RoleTbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-info btn-sm" onclick="edit('<?php echo html_escape($value->role_id)?>')" data-toggle="tooltip" data-placement="left" title="Update"  ><i class="fa fa-pencil" aria-hidden="true"></i></a>
