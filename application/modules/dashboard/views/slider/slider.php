    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-sm" language_list>
                        <thead>
                            <tr>
                                ...
                                <th width="20%"><?php echo display('description'); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="slidertitle_edit('<?php echo html_escape($team_title->widgetid); ?>')"
                ...
                <!-- The Modal -->
                <div class="modal fade" id="slider_info" role="dialog">
                            ...
                            <?php if (!empty($company_list)) { ?>
                                ...
                                <?php foreach ($company_list as $company) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" onclick="sliderimage_edit('<?php echo html_escape($company->slid); ?>')" class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>  
                                            <a href="javascript:void(0)" onclick="sliderdelete('<?php echo html_escape($company->slid); ?>')" class="btn btn-danger custom_btn " onclick="return confirm('<?php echo display("are_you_sure") ?>')" data-toggle="tooltip" data-placement="right" title="Delete "><i class="ti-trash" aria-hidden="true"></i></a>
