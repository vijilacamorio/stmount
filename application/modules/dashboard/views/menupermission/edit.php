            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("dashboard/permission_setup/update",array('id'=>'myform')) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="menu_title" value="<?php echo html_escape($menu_item->menu_title);?>" class="form-control" type="text">
                        </div>
                    </div>
                    
                    <input type="hidden" name="menu_id" value="<?php echo html_escape($menu_item->menu_id);?>">

                    <div class="form-group row">
                        <label for="page_url" class="col-sm-3 col-form-label"><?php echo display('page_url')?></label>
                        <div class="col-sm-9">
                            <input name="page_url" value="<?php echo html_escape($menu_item->page_url);?>" class="form-control" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="module" value="<?php echo html_escape($menu_item->module);?>" class="form-control" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                     ...
                     <?php echo ($menu_item->is_report==1?'checked':'')?>
...
<input type="hidden" id="menuItem" value="<?php echo html_escape($menu_item->parent_menu);?>">
 
<script src="<?php echo MOD_URL.$module;?>/assets/js/menupermissionEdit.js"></script>
