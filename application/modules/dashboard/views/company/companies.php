    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6><?php echo display("brand_logo") ?></h6>    
            </div>
            <div class="card-body">
                <!-- language -->
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="companies_title_edit('<?php echo html_escape($team_title->widgetid); ?>')"
                                        class="btn btn-primary custom_btn ss"><i class="ti-pencil-alt"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                ...
                <!-- The Modal -->
                <div class="modal fade" id="company_info" role="dialog">
                            ...
                            <?php if (!empty($company_list)) { ?>
                                ...
                                <?php foreach ($company_list as $company) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" onclick="company_edit('<?php echo html_escape($company->slid); ?>')" class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>  
                                        </td> 
                                    </tr>
                                <?php } ?>
                            <?php } ?>
