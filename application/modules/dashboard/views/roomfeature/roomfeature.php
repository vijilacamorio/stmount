    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6><?php echo display("room_feature") ?></h6>    
            </div>
            <div class="card-body">
                <!-- language -->
                    ...
                    <table class="table table-bordered table-sm" language_list>
                        <thead>
                            <tr>
                                ...
                                <th width="65%"><?php echo display('title'); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)"
                                        onclick="roomfeaturetitle_edit('<?php echo html_escape($team_title->widgetid); ?>')"
                ...
                <!-- The Modal -->
                <div class="modal fade" id="roomfeature_info" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="roomfeature">
                            ...
                            <?php if (!empty($company_list)) { ?>
                                ...
                                <?php foreach ($company_list as $company) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0)" onclick="roomfeatureimage_edit('<?php echo html_escape($company->slid); ?>')" class="btn btn-primary custom_btn"><i class="ti-pencil-alt"></i></a>  
