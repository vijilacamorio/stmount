...
<div class="sidebar-body">
    <nav class="sidebar-nav">
        <ul class="metismenu">
            ...
            <?php  
                ...
                // module name
                ?>
                 <li class="<?php echo (($this->uri->segment(1)=="customer")?"mm-active":null) ?>"><a
                href="<?php echo base_url('customer/customer-list') ?>"><i class='typcn typcn-user'></i><?php echo display('guest_list')?></a></li>
                <?php
        ...
        "url"        => "reports/night_audit",
                    ...
                    "settlement_summary" => array(
                        "controller" => "report",
                        "method" => "settlement_summary",
                        "url" => "reports/settlement_summary",
                        "permission" => "read",
   ...
   "b2clarge" => array(
                    ...
                    "b2csmall" => array(
                        "controller" => "report",
                        "method" => "b2csmall",
                        "url" => "reports/b2csmall",
                        "permission" => "read",
                        
                    ),


                    "advancereceived" => array(
                        "controller" => "report",
                        "method" => "advancereceived",
                        "url" => "reports/advancereceived",
                        "permission" => "read",
                    ...
                    "advanceadjusted" => array(
                        "controller" => "report",
                        "method" => "advanceadjusted",
                        "url" => "reports/advanceadjusted",
                        "permission" => "read",
            ...
            <?php } ?>
               <li class="<?php echo (($this->uri->segment(1)=="customer")?"mm-active":null) ?>"><a
                href="<?php echo base_url('day_closing/cashregister/cashregisterlist') ?>"><i class='ti-close'></i><?php echo display('day_closing')?></a></li>
