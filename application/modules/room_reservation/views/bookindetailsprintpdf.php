...
function printDiv(divName) {
    ...
    if (rowCount > firstPageRowCount) {
        ...
        if (headerDiv) {
            ...
            helloHeading.innerHTML = '<strong>Bill Date:</strong> <?php echo html_escape($bookinfo->date_time); ?><br><strong>Bill No:</strong> <?php echo $bookinfo->booking_number; ?>';
...
<div class="card">
   <div class="card-body" id="printArea">
    ...
    <strong>Bill Date :</strong> <?php echo html_escape($bookinfo->date_time); ?><br/>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="color: #646a6e; line-height: 30px; vertical-align: top; text-align: right; white-space: nowrap; font-size: 18px;" width="80">
                                       <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php $amt_ttl=array_sum($ratecount); echo $amt_ttl- $bookinfo->discountamount; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                                   </td>
                                </tr>
                                <tr>
