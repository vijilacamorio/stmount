...
<div id="reservation">
   <div class="card mb-4">
      <div class="card-header py-2 ">
         <h6 class="fs-17 font-weight-600 mb-0"><?php echo display("reservation_details") ?> <span id="msg"
            ...
            <?php echo display('booking_list')?></a></small>
         </h6>
      </div>
      <div class="card-body">
         <div class="row">
   ...
   <div class="card mb-4">
      ...
      <div class="card-body">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td class="border-0">
                                    <div class="form-group mb-0">
                                       <label
                                          class="font-weight-600 mb-1"><?php echo "No of persons" ?></label>
                                       <div class="icon-addon addon-md input-left-icon">
                                          <input type="number" min="1"  readonly class="form-control"
         ...
         <!--<th><?php echo display("arrival_from") ?></th>-->
         ...
         <div class="icon-addon addon-md">
         <input type="text" disabled class="form-control datefilter3"
         ...
         <div class="icon-addon addon-md">
         <input type="text" disabled class="form-control datefilter4"
         ...
         <div class="icon-addon addon-md">
         <input type="number" disabled class="form-control total_rent" id="rent"
            value="0">
         </div>
         </div>
         </td>
         ...
         <input type="text" onchange="bedprice()" disabled
            class="form-control ex-room" id="bed" 
         ...
         <input type="hidden" class="bed_total">
         </td>
         <td class="border-0">
         <input type="text"  onchange="personprice()" disabled
            class="form-control ex-room" id="person"
...
<!--         <div class="card-header py-3">-->
<!--            <label for="loving"> -->
<!--            <input id="sp" value="sp" type="checkbox" name="additional">Swimming Pool -->
<!--            </label>-->
<!--            <label for ="lazy">-->
<!--            <input id="cf" value="cf" type="checkbox" name="additional">Camp Fire-->
<!--            </label>-->
<!--            <label for ="energetic">-->
<!--            <input id="proj" value="proj" type="checkbox" name="additional">LCD Projector -->
<!--            </label>-->
<!--         </div>-->
<!--      </div>-->
<!--   </div>-->
            ...
            <div class="row">
               ...
               <div class="col-md-6 mb-3">
                  <div class="row align-items-end">
                     <!-- <div class="col-7"> -->
                        <div class="form-group mb-0">
                           <label class="font-weight-600 mb-1"><?php echo"Discount Amount" ?></label>
                           <div class="icon-addon addon-md">
      ...
      <div class="card flex-fill w-100">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-0 booking_charge" id="booking_charge"><?php echo "0" ?></label>
                  </div>
               </div>
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-0 cgst_charge" id="cgst_charge"><?php echo "0" ?></label>
                     <input type="hidden" class="cgst_charge" id="cgst_charge">
                  </div>
               </div>
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-0 sgst_charge" id="sgst_charge"><?php echo "0" ?></label>
                     <input type="hidden" class="sgst_charge" id="sgst_charge">
                  </div>
               </div>
               ...
               <div class="col-md-6 mb-3 discount_class" style="display: none;">
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-0 discountAmount" id="discountAmount"><?php echo "0" ?></label>
                  </div>
               </div>
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-0 total_charge" id="total_charge"><?php echo "0" ?></label>
      ...
      <div class="card flex-fill w-100">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group mb-0">
                     ...
                     <div class="icon-addon addon-md">
                        <i
                           class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                        <input type="text" disabled class="form-control" class="totalamount" id="totalamount"
              ...
              <div class="col-md-12 mb-3" id="banknamediv" hidden style="display:none;" >
                  <div class="form-group mb-0">
                     <label class="font-weight-600 mb-1"><?php echo "Bank Name" ?></label>
                     <div class="icon-addon addon-md">
                        <input type="text" disabled class="form-control" id="bankname" value="CBI 5532547292"
                           placeholder="Bank Name">
                     </div>
                  </div>
               </div>
               <div class="col-md-12 mb-3" id="accountnumberdiv" hidden style="display:none;" >
                  <div class="form-group mb-0">
...
<!-- <input type="hidden" id="booking_charge" value="<?php echo $taxPercent; ?>"> -->
