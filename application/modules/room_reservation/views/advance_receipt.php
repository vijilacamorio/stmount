...
?>
         ...
         <hr style="margin-top:0;">
         <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800; ">Room No<span style="padding-left:9px;">:</span>  <span style="font-weight: normal;"><?php echo html_escape((!empty($bookinfo->room_no) ? $bookinfo->room_no  : '')); ?></span></p>
         <hr style="margin-top:0;">
         ...
         $pay_info=str_replace("Advance in ","",$paymentinfo->details);
    ...
    <?php if(!empty($customerinfo->gst_no)) { ?>  <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800">GSTIN: <span style="font-weight: normal;"> <?php  echo $customerinfo->gst_no;  ?></span></p>   <?php }  ?>
      ...
      <div class="row mt-3">
         <div class="col-sm-2">
            ...
            $split=explode(" ",$bookinfo->advance_paydate);
         ...
         <div class="col-sm-5">
            <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:400">996311</p>
         </div>
         <div class="col-sm-2">
            <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:400"><?php echo html_escape((!empty($bookinfo->advance_amount) ? '₹'.$bookinfo->advance_amount  : '')); ?></p>
         </div>
      </div>
      <div class="" style="justify-content:right; text-align:right;margin-right:10%">
         <!-- <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800">Sub Total : <span style="font-weight: normal;"> <?php echo html_escape((!empty($bookinfo->advance_amount) ? '₹'.$bookinfo->advance_amount  : '')); ?></span></p>
         <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800;">Net Total : <span style="font-weight: normal;"> <?php echo html_escape((!empty($bookinfo->advance_amount) ? '₹'.$bookinfo->advance_amount  : '')); ?></span></p> -->
      </div>
      ...
      <div class="row">
         ...
         <?php 
$number = (!empty($bookinfo->advance_amount) ? $bookinfo->advance_amount  : 0);
   $no = floor($number);
...
?><br/>
    ...
    <hr style="border-top: 5px dotted #000;">
     ...
     <div class="row">
         ...
         <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800;">Time<span style="padding-left:40px;">:</span> <span style="font-weight: normal;"><?php  echo $currentTime;  ?></span></p>
         <hr style="margin-top:0;">
         <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800; ">Room No<span style="padding-left:8px;">:</span> <span style="font-weight: normal;"><?php echo html_escape((!empty($bookinfo->room_no) ? $bookinfo->room_no  : '')); ?></span></p>
         <hr style="margin-top:0;">
         <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800;">Recipt No  : <span style="font-weight: normal;"><?php echo html_escape((!empty($bookinfo->advance_id) ? $bookinfo->advance_id  : '')); ?></span></p>
         <hr style="margin-top:0;">
        <p style="margin: 0; font-size: 16px; color: #5b5b5b; font-weight:800">Pay Mode :<span style="font-weight: normal;"> <?php  
