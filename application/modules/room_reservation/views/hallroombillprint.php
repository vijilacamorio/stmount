...
?>
    ...
    <body>
        ...
        <div class="invoice-wrap print-hallroom invp-1">
            ...
            <table
                ...
                <thead>
                    <tr>
                        ...
                        <th class="invp-14"><?php echo display("event_name") ?> </th>
                        <th class="invp-14"><?php echo display("event_type") ?> </th>
                        <th class="invp-14"><?php echo display("hall")." ".display("roomtype") ?></th>
                        <th class="invp-14"><?php echo display("hall")." ".display("room_no") ?></th>
                        <th class="invp-14"><?php echo display("rent") ?> </th>
                        <th class="invp-14"><?php echo display("total") ?> </th>
                    </tr>
                </thead>
                <tbody>
                     ...
                     <?php for($i=0;$i<count($ritems); $i++){ ?>   
                            ...
                            <?php foreach ($ritems[$i] as $row) { ?>
                            <tr>
                                <td class="invp-14"><?php echo $sl; ?></td>
                                <td class="invp-14">
                                    <?php echo html_escape($row->event_name); ?></td>
                                <td class="invp-14">
                                    <?php echo html_escape($row->event_type); ?></td>
                                <?php $hallType = $this->db->select("hall_type")->from("tbl_hallroom_info")->where("hid", $row->hall_type)->get()->row(); ?>
                                <td class="invp-14"> <?php echo html_escape($hallType->hall_type); ?>
                                </td>
                                <td class="invp-14"> <?php echo html_escape($row->hall_no); ?>
                                </td>
                                <td class="invp-14"> <?php $subtotal += $row->rent; echo html_escape($row->rent); ?>
                                </td>
                                <td class="invp-14">
                                    <?php $total += $row->totalamount; echo html_escape($row->totalamount); ?></td>
                            </tr>
                            <?php $sl++; ?>
                        <?php } ?>
                    <?php } ?>
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="invp-24">
                <tbody>
                    ...
                    <tr>
                        <td
                            class="invp-25 pl-4">
                            <span><?php echo display("sub_total") ?> </span>
                        </td>
                        <td class="invp-25">
                            <span><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo $subtotal; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="invp-25">
                            <span><?php $scharge = ($hotel_details->servicecharge*$subtotal)/100; if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo $total - $subtotal- $scharge; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                            </span>
                        </td>
                    </tr>
                    <!--<tr>-->
                    <!--    <td-->
                    <!--        class="invp-25 pl-4">-->
                    <!--        <span><?php echo display("service_charge") ?> </span>-->
                    <!--    </td>-->
                    <!--    <td class="invp-25">-->
                    <!--        <span><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo $scharge; ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>-->
                    <!--        </span>-->
                    <!--    </td>-->
                    <!--</tr>-->
    ...
    <script src="<?php echo MOD_URL;?>room_reservation/assets/js/hallprint.js"></script>
