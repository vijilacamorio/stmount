                        ...
                        <tr>
                            ...
                            <td><strong><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                    ...
                                    //    print_r($ratecount);
                                       ...
                                       echo customRound($amt_ttl); ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td hidden>
                                <strong><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="oldallroomrentandtax"><?php echo customRound($amt_ttl+$singletax);  ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                            <td style='display:none;'><strong><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="allroomrentandtax"><?php echo customRound($amt_ttl+$singletax);  ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><strong>
                                    ...
                                    if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="payableamount"><?php echo customRound(($amt_ttl+$allbpccharge+$singletax)-($alladvanceamount-$disamt));  ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td><strong>
                                    <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="netpayableamount"><?php echo html_escape(customRound(($amt_ttl+$allbpccharge+$singletax)-$alladvanceamount-$disamt)) ; ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><strong><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="payableamt"><?php echo customRound(($amt_ttl+$allbpccharge+$singletax)-$alladvanceamount-$disamt);   ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                    ...
                                    <div class="form-floating with-icon">
                                     <select class="selectpicker form-select" data-live-search="true"
                                            ...
                                            <option value="<?php echo html_escape($ptype) ?>">
                                                <?php echo html_escape($ptype) ?></option>
                                            <?php } ?>
                                        </select>
                ...
                <tbody>
                    ...
                    <tr style='border:none'>
                       ...
                       <td style='border:none' class="invp-26" id="sub" width="80">
                           <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo number_format($amt_ttl, 2, '.', ',');;  ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                       </td>
                    </tr>
                 ...
                 <tr id="invadc" hidden>
                    ...
                    <tr>
                        ...
                        <td class=" invp-26">
                           <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo number_format($alladvanceamount, 2, '.', ','); ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td class="invp-28">
                            <strong
                                id="inpayableamt"><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><?php echo customRound(($amt_ttl+$allbpccharge+$singletax)-$alladvanceamount-$disamt);   ?><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                        </td>
                    </tr>
                </tbody>
            </table>
