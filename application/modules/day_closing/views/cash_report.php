<link href="<?php echo base_url('application/modules/day_closing/assets/css/cash_report.css'); ?>" rel="stylesheet"
    type="text/css" />
<div class="table-responsive">
    <table class="table table-bordered table-striped table-hover" id="respritbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="javascript:;"
                        onclick="detailscash('<?php echo $item->openclosedate;?>','<?php echo $item->opening_balance;?>','<?php echo $item->userid;?>','<?php echo $item->closing_balance;?>')"
                        class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title=""
                        data-original-title="Details"><i class="fa fa-eye"></i></a></td>
            </tr>
        ...
        <tfoot class="cash-report-footer">
            <tr>
                <td class="cash-report-total" colspan="3" align="right">&nbsp; <b><?php echo display('total') ?> </b>
                </td>
