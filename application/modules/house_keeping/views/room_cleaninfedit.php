        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="room_no" class="col-sm-4 col-form-label"><?php echo display('room_no') ?> <span
                ...
                <div class="form-group row">
                    <label for="assignto" class="col-sm-4 col-form-label"><?php echo display('assignto') ?> <span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="date_start" class="col-sm-4 col-form-label"><?php echo display('date_start') ?> <span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input name="date_start" autocomplete="off" class="datetimepickers form-control" type="text"
                            placeholder="<?php echo display('date_start') ?>" value="<?php echo date("Y-m-d H:i:s") ?>"
                            id="date_start">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="date_end" class="col-sm-4 col-form-label"><?php echo display('date_end') ?> <span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input name="date_end" autocomplete="off" class="datetimepickers form-control" type="text"
                            placeholder="<?php echo display('date_end') ?>"
                            value="<?php echo date("Y-m-d H:i:s",strtotime('+15 minutes')) ?>" id="date_end">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select name="status" class="selectpicker form-control readonly" data-live-search="true"
                            id="status">
                ...
                <div class="form-group">
                    <label for="product_list" class="col-sm-3 col-form-label"><?php echo display('product_list') ?>
                    </label>
                    <?php foreach($hkproducts as $list){ ?>
                    <?php $tooltrips = html_escape($list->product_name);?>
                    <div class="col-md-12 pb-2">
                        <div class="form-check form-check-inline w-100">
                            <input type="checkbox" class="form-check-input test" name="products_id[]"
                                id="hkproduct<?php echo html_escape($list->id);?>"
                                value="<?php echo html_escape($list->id);?>">
                            <label class="form-check-label width_66 col-sm-10" data-toggle="tooltip"
                                data-placement="top" title="<?php echo html_escape($tooltrips);?>"
                            ...
                            <input type="number" min="1" class="col-sm-2"
                                ...
                                id="hkproduct_qty<?php echo html_escape($list->id);?>" value="0" disabled>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <?php } ?>
                <div class="form-group">
                    <label for="checklist" class="col-sm-3"><?php echo display('checklist') ?> </label>
                    <?php foreach($checklist as $list){ ?>
                    <?php $tooltrips = html_escape($list->taskname);?>
                    <div class="col-md-12 pb-2">
                        <div class="form-check form-check-inline w-100">
                            <input type="checkbox" class="form-check-input test" name="checklist_id[]"
                                id="hkchecklist<?php echo html_escape($list->checklist_id);?>"
                                value="v_<?php echo html_escape($list->checklist_id);?>">
                            <label class="form-check-label width_66 col-sm-10" data-toggle="tooltip"
                                data-placement="top" title="<?php echo html_escape($tooltrips);?>"
                                ><?php echo html_escape($list->taskname);?></label>
                        </div>
                    </div>
                    <?php } ?>
                </div>
