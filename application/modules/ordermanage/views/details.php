                     ...
                     <div  style="margin-top: -70px;" >
                        ...
                        <?php } ?>
                          <?php  
                              ...
                              ?> 
                            <div style='white-space: normal;overflow-wrap: break-word;word-break: break-all; max-width: 100%;'><strong><?php echo ('Room No');?> : </strong><?php echo htmlspecialchars($billinfo->room_number); ?></div>
                           <?php } ?>
                     </div>
                  </div>
               </div>
                     ...
                     <tfoot>
                        <tr>
                           <td class="text-right" colspan="3">
                              <strong><?php echo ('Amount')?><?php if(!empty($discountpr)){echo number_format($discountpr, 2, '.', '');}?></strong>
                           </td>
                           <td class="text-right Rightalign">
                              <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                              <?php echo number_format($total_amount=$billinfo->total_amount, 2, '.', ''); ?>
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>                               
                           </td>
                        </tr>
                        <tr>
                           <td class="text-right" colspan="3">
                              <strong><?php echo display('discount')?><?php if(!empty($discountpr)){echo number_format($discountpr, 2, '.', '');}?></strong>
                           </td>
                           <td class="text-right Rightalign">
                              <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                              <?php $discount=0; if(empty($billinfo)){ echo $discount;} else{echo number_format($discount=$billinfo->discount, 2, '.', '');} ?>
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>                               
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="text-right Rightalign">
                              <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>                                          
                              <?php echo number_format($itemtotal - $billinfo->discount, 2, '.', '');?>    
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>
                           </td>
                        </tr>
                           ...
                           <td class="text-right Rightalign">
                              ...
                              <?php
                                 if($discount > 0){
                                     ...
                                     echo number_format($orderinfo->cgst, 2, '.', ''); 
                                 }
                                 ?>
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>
                           </td>
                           ...
                           <td class="text-right Rightalign">
                              ...
                              <?php
                                 if($discount > 0){
                                     ...
                                     echo number_format($orderinfo->sgst, 2, '.', ''); 
                                 }
                                 ?>
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>
                           </td>
                           ...
                           <td class="text-right Rightalign">
                              ...
                              <?php
                                 if($discount > 0) {
                                     ...
                                     echo customRound($billinfo->bill_amount);
                                 }
                                 ?>
                              <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>
                           </td>
