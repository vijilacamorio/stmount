...
<div class="page-wrapper">
        <div class="invoice-card">
            <div class="invoice-head">
                <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage/assets/images/dum_ordermanage_ivc.png')?>" alt="">
           ...
           <?php $i++;} }}?>
			...
			?>
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php if(!empty($changes)){echo $changes;} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
            ...
            <div class="invoice_address">
                ...
                <div class="middle-data">
                    <div class="item-info gap_right">
                        <h5 class="item-title"><?php echo display('table');?>: <?php if(!empty($tableinfo->tablename)){echo  $tableinfo->tablename;} ?></h5>
                    </div>
                    <div class="item-info">
