...
<body>
        ...
        <div class="invoice-card">
            <div class="invoice-head">
                <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage/assets/images/dmi_logo.jpeg')?>" alt="" width="168" height="65">
                <!-- <div> -->
                ...
                <h5><?php echo "For Retreat and Pilgrimage";?></h5>
                <h5><?php echo "Hill Top, St.Thomas Mount, Chennai, 600016, India ";?></h5>
        <h5><?php echo "Ph: 04422344756, 9444376141 Fax :044 22314859";?></h5>
                <h5><?php echo "Email: sticdmi2000@gmail.com";?></h5>
            </div>
            </div>   
			...
			<div class="invoice_address">
                <div class="row-data">
                    ...
                    <?php if($storeinfo->isvatnumshow==1){?><h5 class="item-title"><?php echo display('tinvat');?><?php if(!empty($storeinfo->vattinno)){echo ': '.$storeinfo->vattinno;}?></h5><?php } ?>
                </div>
            </div>
            ...
            <div class="invoice-footer mb-15">
                ...
                <div class="row-data" >
                    <div class="item-info">
                        <h5 class="item-title"><?php echo ('CGST')?>(<?php echo '2.5';?>%)</h5>
                    </div>
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $orderinfo->cgst;?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo ('SGST')?>(<?php echo '2.5';?>%)</h5>
                    </div>
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $orderinfo->sgst;?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <div class="row-data" style="display:none;">
                    <div class="item-info">
            ...
            <div class="invoice_address">
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('billing_to');?>: <?php echo $customerinfo->firstname.' '.$customerinfo->lastname;?></h5>
                    </div>
                ...
                <div class="middle-data">
                    <div class="item-info gap_right">
                        <h5 class="item-title"><?php echo ('Room Number');?>: <?php if(!empty($billinfo)){echo $billinfo->room_number;} ?></h5>
                    </div>
                    <div class="item-info">
