            ...
            <div class="card-body">
 					<?php echo  form_open('ordermanage/order/createcounter',array('id'=>'menuurl')) ?>
                        <div class="form-group row">
                            <label for="counter" class="col-sm-2 col-form-label"><?php echo display('counter_no') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-3">
                    ...
                    <table class="table table-bordered table-hover" id="RoleTbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="editmenu('<?php echo $counter->counterno; ?>',<?php echo $counter->ccid; ?>)"  data-toggle="tooltip" data-placement="left" title="Update" class="btn btn-success btn-sm"><i class="ti-pencil" aria-hidden="true"></i></a>
