                ...
                <div class="panel-body">
                    ...
                    <?php echo form_hidden('menutypeid', (!empty($intinfo->menutypeid)?$intinfo->menutypeid:null)) ?>
                        ...
                        <div class="form-group row">
                            <label for="menu_type_name" required class="col-sm-4 col-form-label"><?php echo display('menu_type_name') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
						...
						<div class="form-group row">
                        <label for="lastname" class="col-sm-4 col-form-label"><?php echo display('status') ?><span class="text-danger">*</span></label>
                        <div class="col-sm-8">
