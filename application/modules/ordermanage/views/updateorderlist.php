<div class="table-wrapper-scroll-y productclist">
                    ...
                    $pvat=0;
                        ...
                        if (!empty($iteminfo->productvat)) {

                          $up_productvat = $iteminfo->productvat;
                        }else {
                          $up_productvat = 0;
                        }

										  $vatcalc=$itemprice*$up_productvat/100;
										  $pvat=$pvat+$vatcalc;
										  }
										if($iteminfor->OffersRate>0){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php if($this->permission->method('ordermanage','delete')->access()){?><a class="btn btn-danger btn-sm btnrightalign" onclick="deletecart(<?php echo $item->row_id;?>,<?php echo $item->order_id;?>,<?php echo $item->menu_id?>,<?php echo $item->varientid?>,<?php echo $item->menuqty;?>)"><i class="ti-trash" aria-hidden="true"></i></a><?php } ?></td>
                                     </tr>
                                    <?php 
									if(!empty($item->add_on_id)){
										$y=0;
                    ...
                    $sgst=$itemtotal*2.5/100;
                                ...
                                <input name="multiplletaxvalue" id="multiplletaxvalue_update" type="hidden" value="<?php if(!empty($multiplletaxvalue)){echo $multiplletaxvalue;} ?>" />
<table class="table table-bordered bg-white">
                                <?php $servicecharge=0;
                                            if(empty($billinfo)){
                                                ...
                                                ?>
                                            <?php $discount=0;
							$customerinfo=$this->order_model->read('*', 'customerinfo', array('customerid' =>$billinfo->customer_id));
                                            ...
                                            if(empty($billinfo)){
                                                $discount=$pdiscount;
                                                  ...
                                                  if (!empty($mtype->discount)) {
                                                    $mtype_discount = $mtype->discount;
                                                  }else {
                                                    $mtype_discount = 0;
                                                  }
													$newsubtotal=$subtotal-$pdiscount;
													$discount=$pdiscount+($mtype_discount*$newsubtotal/100);
        ...
        //                                     $servicecharge=0;
							 ...
							 //							 $servicecharge=$settinginfo->servicecharge*$totalsercharge/100;
                                ...
                                <tr>
                                    <td class="text-right wpr_494"><strong><?php echo ('GST')?></strong></td>
                                    <td class="text-right wpr_28">
                                   
                                    <input id="vat_update" name="vat" type="hidden" value="<?php echo $calvat;?>" />

                                    <input id="cgst" name="cgst" type="hidden" value="<?php echo $cgst;?>" />
                                    <input id="sgst" name="sgst" type="hidden" value="<?php echo $sgst;?>" />
                                    ...
                                    <tr>
                                        <td class="text-right wpr_494"><strong><?php echo ('CGST')." ".'(2.5%)'?></strong></td>
                                      
                                        <td class="text-right wpr_28"><input id="calvat1" name="cgst"    type="hidden"  value="<?php echo $cgst;?>" />

                                            <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                            
                                            <span id="calvat1"> <?php echo $cgst;?></span>                                               
                                    ...
                                    <tr>
                                        <td class="text-right wpr_494"><strong><?php echo ('SGST')." ".'(2.5%)'?></strong></td>
                                      
                                        <td class="text-right wpr_28"><input id="calvat2"   type="hidden"  name="sgst"  value="<?php echo $sgst;?>" />

                                            <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                            
                                            <span id="calvat2"> <?php echo $sgst;?></span>                                               
