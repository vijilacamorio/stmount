...
?>
    ...
    <div class="form-group col-md-6">
        ...
        value="<?php echo customRound($grand); ?>" 
...
<div class="cardarea5 w-100 no-gutters row display-none" style="margin-left: 0px">
    ...
    <div class="cardarea6 w-100 no-gutters row display-none ml-0">
        ...
        <label for="bank_name" class="col-form-label"><?php echo "Bank Name";?></label>
         <input type="text" class="form-control" placeholder="Bank Name" id="bank_name" name="bank_name[]" value="CBI 5532547292" />
    </div>
       <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" placeholder="Card Number"  name="card_number" value="" />

         </div>
        <div class="form-group col-md-6">
            <label for="bank" class="col-form-label"><?php echo  ('Expiry Date');?></label>
            <input type="number" class="form-control" placeholder="Expiry Date" name="expiry_date" value="" />
...
document.getElementById('paymentnow').addEventListener('click', function() {
  ...
  $('#pay_bill').show(); 
    ...
    document.getElementById('subtotal').textContent = final.toFixed(2); // Update the 'subtotal' cell
    ...
    document.getElementById('sgst').textContent = sum1.toFixed(2);
    ...
    document.getElementById('grandamount').textContent = customRound(grand);
    document.getElementById('enterdis').textContent = disAmount.toFixed(2);
    document.getElementById('paidamount_marge').value = customRound(grand);

    document.getElementsByClassName('newgt').textContent = customRound(grand);
