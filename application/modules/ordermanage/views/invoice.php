 ...
 <div id="printableArea">
	                    <div class="panel-body">
	                        <div class="row">
								...
								<img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage/assets/images/dmi_logo.jpeg')?>" class="img img-responsive height-mb" alt="">
	                                <br>
	                        ...
	                        <div class="table-responsive m-b-20">
                             ...
                             <tr style="display:none;">
									...
									<tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo ('CGST')?> (<?php echo '2.5';?>%)</strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $orderinfo->cgst; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
									<tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo ('SGST')?> (<?php echo '2.5';?>%)</strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $orderinfo->sgst; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
                                   <?php }else{
										$i=0;
