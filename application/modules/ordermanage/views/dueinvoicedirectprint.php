...
<body>
  ...
  <div class="invoice-card">
    <div class="invoice-head"> <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage/assets/images/dmi_logo.jpeg')?>" alt=""  width="168" height="65">
    <!-- <div style="text-align: center;"> -->
    <div style="margin: 0 auto; width: fit-content;text-align: center; ">
    <h3><?php echo $storeinfo->storename;?></h3>
        ...
        <div class="invoice_address">
          <div class="row-data">
            ...
            <h5 class="item-title"><?php echo display('tinvat');?><?php if(!empty($storeinfo->vattinno)){echo ': '. $storeinfo->vattinno;} ?></h5>
            <?php } ?>
          </div>
        </div>
    ...
    <?php
    if (!empty($billinfo)) {
        $room_numbers = explode(',', $billinfo->room_number); // Split room numbers into an array
        foreach ($room_numbers as $index => $room_number) {
            echo $room_number; // Output each room number
            if ($index < count($room_numbers) - 1) {
                echo ', '; // Add a comma and space after each room number except the last one
            }
        }
    }
    ?>
