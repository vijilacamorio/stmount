            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12" id="findfood">
                        <table class="table datatable table-fixed table-bordered table-hover bg-white"
                            id="exdatatable">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $item->order_id;?></td>
                                                                        ...
                                                                        <td class="text-center"><?php echo $item->saleinvoice;?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url("ordermanage/order/orderdetails/$item->order_id") ?>"
                                            class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left"
                                            title="Details"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        <?php endif; ?>
                                        <a href="<?php echo base_url("ordermanage/order/posorderinvoice/$item->order_id") ?>"
                                            class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left"
                                            title="" data-original-title="Invoice"><i class="fa fa-window-restore"
