        ...
        <div class="">
            ...
            <div class="row">
                        ...
                        <div class="col-md-12">
                            <form class="navbar-search" method="get" action="<?php echo base_url("ordermanage/order/pos_invoice")?>" >
                                ...
                                <div class="input-group">
                                    <select id="update_product_name" onchange="update_product_namesrc()" class="form-control dont-select-me  update_search-field" dir="ltr" name="s">
                                    </select>
                                ...
                                <div class="row row-m-3" id="product_search_update">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-p-3">
                                        <div class="card product-card positemcard update_select_product">
                                            ...
                                            <div class="card-footer"><span><?php echo $item->ProductName;?> (<?php echo $item->variantName;?>)<?php if(!empty($item->itemnotes)){ echo " -".$item->itemnotes;}?></span></div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                ...
                <div class="col-md-5">
                    ...
                    <input name="custmercode" type="hidden" id="custmercode" value="<?php echo $customerinfo->customernumber;?>" />
                    <input name="custmername" type="hidden" id="custmername" value="<?php echo $customerinfo->firstname;?>" />
                    <input name="saleinvoice" type="hidden" id="saleinvoice" value="<?php echo $orderinfo->saleinvoice;?>" />
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="customer_name"><?php echo display('customer_name')."(".display('checkin').")";?> <span class="color-red">*</span></label>
                            <div class="d-flex">
                                <?php $cusid=1;
                                        ...
                                        <tbody>
                                            ...
                                            $tx++;
                                                                                            ...
                                                                                            if (!empty($iteminfo->productvat)) {
                                                                                                $prodvat = $iteminfo->productvat;
                                                                                            }else {
                                                                                                
                                                                                                $prodvat = 0;
                                                                                            }

                                                                                        $vatcalc=$itemprice*$prodvat/100;
                                                                                        $pvat=$pvat+$vatcalc;
                                                                                        }
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php if($orderinfo->order_status!=4){?><a class="btn btn-danger btn-sm btnrightalign" onclick="deletecart(<?php echo $item->row_id;?>,<?php echo $item->order_id;?>,<?php echo $item->menu_id?>,<?php echo $item->varientid?>,<?php echo $item->menuqty;?>)"><i class="ti-trash" aria-hidden="true"></i></a><?php } ?></td>
                                            </tr>
                                            <?php
                                            if(!empty($item->add_on_id)){
                                            $y=0;
                            ...
                            <table class="table table-bordered bg-white">
                                <tr>
                                    ...
                                    <td class="text-right wpr_28">
                                        ...
                                        ?>
                                        <?php $discount=0;
                                                                                    $customerinfo=$this->ordermodel->read('*', 'customerinfo', array('customerid' =>$billinfo->customer_id));
