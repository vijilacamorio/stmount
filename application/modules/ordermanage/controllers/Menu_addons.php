...
class Menu_addons extends MX_Controller {
    ...
    public function index()
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('ordermanage/menu_addons/index');
	  ...
	  if ($this->form_validation->run()) { 
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		$this->logs_model->log_recorded($logData);
		 ...
		 redirect('ordermanage/menu_addons/create');
		} else {
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		redirect("ordermanage/menu_addons/create/".$postData['add_on_id']);  
	   }
	  } else { 
    ...
    public function delete($addons = null)
    {
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		redirect('ordermanage/menu-addons-list');
    }
	...
	public function assignaddons($id = null)
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('ordermanage/menu_addons/assignaddons');
    ...
    public function assignaddonscreate($id = null)
    {
	  ...
	  if ($this->form_validation->run()) { 
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		$this->logs_model->log_recorded($logData);
		 $this->session->set_flashdata('message', display('save_successfully'));
		 redirect('ordermanage/menu_addons/assignaddons');
		} else {
		 $this->session->set_flashdata('exception',  display('please_try_again'));
		}
		redirect("ordermanage/menu_addons/assignaddons"); 
 ...
 public function assignaddonsupdateinfo($id){
		...
		$this->load->view('ordermanage/assignaddonsedit', $data);   
