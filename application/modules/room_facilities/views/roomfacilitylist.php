<div class="card">
    ...
    <div class="card-header">
        ...
        aria-hidden="true"></i>
        <?php echo display('add_facility_type')?></button></small></h4>
    </div>
    <?php endif; ?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="facilityname"
                                            class="col-sm-4 col-form-label"><?php echo display('facility_name') ?>
                                            <span class="text-danger">*</span></label>
                                            <div class="col-sm-8">
                                                <input name="facilityname" class="form-control" type="text"
                                                placeholder="<?php echo display('facility_name') ?>" id="facilityname"
                                                value="">
                                            </div>
                                        </div>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                ...
                                <td class="center">
                                    ...
                                    <a onclick="editinfo('<?php echo html_escape($type->facilitytypeid); ?>')"
