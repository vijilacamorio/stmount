...
<div class="row">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md input-left-icon">
                                <select class="selectpicker form-select" <?php if ($bookingpaymentdata->paymenttype){ echo "disabled"; } ?> data-live-search="true" data-width="100%"
                                    ...
                                    <option
                                        <?php if(!empty($bookingpaymentdata)){ if($bookingpaymentdata->paymenttype){echo 'selected';}} ?>
  ...
  <div class="col-md-12 mb-3" id="banknamediv" <?php if ($payment_method->paymenttype != 'Bank Payment') { echo "hidden"; } ?>  style="display:none;" >
    <div class="form-group mb-0">
