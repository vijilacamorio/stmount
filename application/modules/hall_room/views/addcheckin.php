...
<div id="reservation">
    <div class="card mb-4">
        <div class="card-header py-2 ">
            <h6 class="fs-17 font-weight-600 mb-0"><?php echo display("hall_room")." ".display("checkin") ?>
                <span id="msg" class="red-message"></span><small class="float-right"><a href="#" id="view_checin"
                        ...
                        <?php echo display("hall")." ".display('checkin')?></a></small>
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="border-0">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="number"  class="form-control form-control" id="rent"
                                                value="0">
                                        </div>
                                    </div>
                                </td>
            ...
            <div class="card-body">
                <div class="row">
                    <?php
                     ...
                     //  echo $payment_method->details;die();
                  $ref=explode(':', $ref_no);
                  $ref=$ref[1];
                  ?>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <i
                                    ...
                                    <input type="hidden" class="add_checkin" value="add_checkin">
                           <?php
                     $currentYear = date('Y');
                         $currentMonth = date('m');
