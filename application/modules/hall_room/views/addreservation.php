    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mb-3">
                    <div class="form-group mb-0">
                        <label class="font-weight-600 mb-1"><?php echo display("event_type") ?></label>
                        <div class="icon-addon addon-md">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <select class="selectpicker form-select" data-live-search="true"
                                                            data-width="100%" onchange="getcapcity()" id="room_type">
                                                            <option value="" selected>Choose <?php echo display("hallroom_type") ?></option>
                                                                <?php foreach($hallroomdetails as $btype): ?>
                                                                    <?php if ($btype->room_status == 0): ?>
                                                                        <option value="<?php echo html_escape($btype->hid); ?>">
                                                                            <?php echo html_escape($btype->hall_type); ?>
                                                                        </option>
                                                                    <?php endif; ?>
                                                                <?php endforeach; ?>
                                                        </select>
                            ...
                            <tr>
                                ...
                                <td class="border-0">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="number" name="rent" disabled class="form-control form-control" id="rent"
                                                value="">
                                        </div>
                                    </div>
                                </td>
    ...
    <div class="col-lg-12 d-flex">
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <span class="cgst_charge"><?php echo "0" ?></span>
                        </div>
                    </div>
                    <div class="col-md-2 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mt-4"><?php echo "SGST(9%)" ?></label>
                            <span class="sgst_charge"><?php echo "0" ?></span>
                        </div>
                    </div>
                   
                   <div class="col-md-4 mb-3" id="chequenodiv" hidden>
                    <div class="form-group mb-0">
               ...
               <div class="col-md-2 mb-3" id="chequedatediv" hidden>
                  <div class="form-group mb-0">
               ...
               <div class="col-md-6 mb-3" id="onlinereferencediv" hidden>
                  <div class="form-group mb-0">
            ...
            <div class="col-md-12 mb-3" id="banknamediv" hidden style="display:none;">
               ...
               <div class="col-md-6 mb-3" id="upireferencediv" hidden>
                  <div class="form-group mb-0">
               ...
               <div class="col-md-3 mb-3" id="carddiv" hidden>
                  <div class="form-group mb-0">
               ...
               <div class="col-md-2 mb-3" id="cardexpirediv" hidden>
                  <div class="form-group mb-0">
               ...
               <div class="col-md-1 mb-3" id="cardcvvdiv" hidden>
                  <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                                    <input type="hidden" id="c_charge" class="cgst_charge">
                                    <input type="hidden" id="s_charge" class="sgst_charge">
                         <?php
                     $currentYear = date('Y');
                         $currentMonth = date('m');
