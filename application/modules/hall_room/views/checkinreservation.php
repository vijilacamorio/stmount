...
<div id="reservation">
    <div class="card mb-4">
        <div class="card-header py-2 ">
            <h6 class="fs-17 font-weight-600 mb-0"><?php echo display('checkin') ?><span id="msg"
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mb-3">
                    <div class="form-group mb-0">
                        ...
                        <div class="icon-addon addon-md">
                            ...
                            <input type="hidden" class="editCheckIN" value="EDITCHEDKIN">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-4 mb-3">
    ...
    <div class="card mb-4">
        ...
        $tax = ($setting->tax*$totalamount)/100;
        $scharge = ($setting->servicecharge*$totalamount)/100;
       $totalamount += ($bookingdata->cgst+$bookingdata->sgst);
        ...
        <div class="card-body">
            ...
            <th class="rentinfo-seatplan"><?php echo display('rent_info') ?></th>
            </tr>
            <tr>
                <td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border-0">
                                    <div class="form-group mb-0">
                                        <label
                                            class="font-weight-600 mb-1"><?php echo display("hall_room")." ".display("rent"); ?>
                                        </label>
                                        <div class="icon-addon addon-md">
...
<div class="row">
    ...
    <div class="form-group mb-0">
        ...
        <div class="icon-addon addon-md">
            <input type="text" <?php if ($bookingpaymentdata->paymenttype == 'Bank Payment') { echo "readonly"; } ?> value='<?php echo $ref_acc_no[0]; ?>' class="form-control" id="bankname" style="width: 858px;" placeholder="Bank Name">
        </div>
    </div>
</div>
...
<div class="col-md-12 mb-3" id="accountnumberdiv"  <?php if ($bookingpaymentdata->paymenttype != 'Bank Payment') { echo "hidden"; } ?> >
   <div class="form-group mb-0">
                     ...
                     <div class="icon-addon addon-md">
                        <input type="text" <?php if ($bookingpaymentdata->paymenttype == 'Bank Payment') { echo "readonly"; } ?> value='<?php echo $ref_acc_no[1]; ?>' class="form-control" id="accountnumber"
                           placeholder="mm/yyyy">
                        <label class="fas fa-credit-card"></label>
                     </div>
                  </div>
