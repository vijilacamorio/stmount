...
if (!isNaN(rentafterdiscount1)) {
 ...
 $("#totalroomrentamount").text(parseFloat(rentafterdiscount1));
    ...
    //     creditamount;
       ...
       var val=parseFloat(rentafterdiscount1)+additionalcharge+parseFloat(tax12percent)-alladvanceamount;
...
if (!isNaN(rentafterdiscount1)) {
 ...
 $("#t_rent").text(parseFloat( $('#rnt').text()));
      $('.sub').text((parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
       $("#payableamount").text((additionalcharge+parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
        $("#netpayableamount").text((additionalcharge+parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
        $("#payableamt").text((additionalcharge+parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
         $("#balance").text((additionalcharge+parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
...
if (!isNaN(rentafterdiscount1)) {
 ...
 $("#totalroomrentamount").text(parseFloat(rentafterdiscount1));
    ...
    //     creditamount;
       ...
       var val=parseFloat(rentafterdiscount1)+additionalcharge+parseFloat(tax12percent)-alladvanceamount;
        $("#allroomrentandtax").text(val.toFixed(2));
        $("#payableamount").text(parseFloat(rentafterdiscount1)+parseFloat(tax12percent)-alladvanceamount);
        $("#netpayableamount").text(val.toFixed(2));
        $("#payableamt").text(val.toFixed(2));
 ...
 $("#t_rent").text(parseFloat( $('#rnt').text()));
      $('.sub').text((parseFloat(totalrentandtax)+cgst+sgst-alladvanceamount).toFixed(2));
       $("#payableamount").text((parseFloat(totalrentandtax)+cgst+sgst+additionalcharge-alladvanceamount).toFixed(2));
        ...
        $("#payableamt").text((parseFloat(totalrentandtax)+cgst+sgst+additionalcharge-alladvanceamount).toFixed(2));
         $("#balance").text((parseFloat(totalrentandtax)+cgst+sgst+additionalcharge-alladvanceamount).toFixed(2));
       var t=parseFloat($('.adv').text())+(parseFloat(totalrentandtax)+cgst+sgst).toFixed(2);
       var advValue = parseFloat($('.adv').text());
