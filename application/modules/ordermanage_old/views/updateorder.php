                ...
                <div class="col-md-12">
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-p-3">
                                            <div class="card product-card positemcard update_select_product">
                                                ...
                                                <div class="card-footer"><span><?php echo $item->ProductName;?>
                                                        (<?php echo $item->variantName;?>)<?php if(!empty($item->itemnotes)){ echo " -".$item->itemnotes;}?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div id="nonthirdparty_update" class="col-md-12" style='display:none;'>
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-6 form-group" id="tblsec_update display-none" style='display:none;'>
                                        <label
                            ...
                            <div id="thirdparty_update" class="col-md-12 display-none" style='display:none;'>
                            ...
                            <div class="form-group">
                                <input class="form-control" type="date" id="order_date" name="order_date" required
                                    value="<?php echo $orderinfo->order_date ; ?>" />
                              ...
                              //  }
                                ...
                                <table class="table table-bordered bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right wpr_28"><input id="calvat2" name="sgst"  type="hidden"  value="<?php echo $sgst;?>" />
