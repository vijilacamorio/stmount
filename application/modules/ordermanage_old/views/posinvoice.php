    ...
    <h3><?php echo $storeinfo->storename;?></h3>
        ...
        <h5><?php echo "Email: sticdmi2000@gmail.com";?></h5>
			...
			<div class="invoice_address">
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('date');?><?php if(!empty($orderinfo->order_date)){ echo ': '. date("M d, Y", strtotime($orderinfo->order_date));}?></h5>
                    </div>
                </div>
            </div>
            <div class="invoice-details">
                <div class="invoice-list">
                    ...
                    <div class="invoice-data">
                        <?php $this->load->model('ordermanage/order_model',	'ordermodel', TRUE);
				  $i=0; 
				  $totalamount=0;
					  $subtotal=0;
