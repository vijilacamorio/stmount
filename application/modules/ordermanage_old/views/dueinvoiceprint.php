...
<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
    ...
    <div class="pt-5">
        <div class="bill-pos-mini__logo border" align="center"> <img src="<?php echo base_url();?><?php echo (file_exists($comsettinginfo->invoice_logo)?$comsettinginfo->invoice_logo:'application/modules/ordermanage/assets/images/dmi_logo.jpeg')?>" class="img img-responsive" alt=""></div>
    </div>
    <div class="px-4">
        ...
        <p><?php echo "Hill Top, St.Thomas Mount, Chennai, 600016, India "; ?>:</p> <br>
                                <p><?php echo display('mobile') ?>:</p> <?php echo $storeinfo->phone;?><br>
        ...
        <div class="border-bottom--dashed">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
             ...
             <div class="d-flex justify-content-between align-items-center mb-2" style="display:none;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                <p class="mb-0 text-note text-primary"><?php echo ('CGST')?>(<?php echo '2.5';?>%)</p>
                <p class="mb-0 text-note text-primary"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $orderinfo->cgst; ?><?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <div class="d-flex justify-content-between align-items-center mb-2">
                <p class="mb-0 text-note text-primary"><?php echo ('SGST')?>(<?php echo '2.5';?>%)</p>
                <p class="mb-0 text-note text-primary"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $orderinfo->sgst;?><?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
