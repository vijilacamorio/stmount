...
class Item_category extends MX_Controller {
    ...
    public function index()
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('ordermanage/item_category/index');
    ...
    public function create($id = null)
    {
	  ...
	  $img = $this->fileupload->do_upload(
		'./application/modules/ordermanage/assets/images/','picture'
	 ...
	 $logData = array(
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		if ($this->category_model->cat_create($postData)) { 
		 ...
		 redirect('ordermanage/category-create');
		} else {
	  ...
	  $logData = array(
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		redirect("ordermanage/item_category/create/".$postData['CategoryID']);  
	   }
	  } else { 
	   if(!empty($id)) {
    ...
    public function delete($category = null)
    {
	   ...
	   'entry_date'          => date('d-m-Y H:i:s'),
		...
		redirect('ordermanage/item_category/index');
    }
