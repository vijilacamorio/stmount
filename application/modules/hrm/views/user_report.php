                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('hrm/attendance-report-list') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="start_date" class="datepickers form-control" type="text" placeholder="<?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="end_date" class="datepickers form-control" type="text" placeholder="<?php  
